...
speak.i18n:Load({
    en = {
        ...
        GOOGLE = "Google Hangouts Style",
        TWITTER = "Twitter Style",
        EMOJI_ONE = "Emoji One Style",
        ...
        DISPLAY_MESSAGE_ABOVE_HEAD = "Display partial messages above player's heads",
    ...
    sv = {
        ...
        DISPLAY_MESSAGE_ABOVE_HEAD = "Visa text över en spelares huvud medans den skriver.",
    ...
    fr = {
        ...
        GOOGLE = "Style Google Hangouts",
        TWITTER = "Style Twitter",
        EMOJI_ONE = "Style Emoji One",
        ...
        DISPLAY_MESSAGE_ABOVE_HEAD = "Afficher les messages au-dessus de la tête",
